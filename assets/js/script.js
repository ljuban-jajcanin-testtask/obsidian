...
mobileMenu.onclick = function(){
    if(document.querySelector('.mobile-navigation').classList.contains("active-navigation")){
        document.querySelector('.mobile-navigation').classList.remove("active-navigation");
    }else{
        document.querySelector('.mobile-navigation').classList.add("active-navigation");
    }
}

/* GET ELEMENTS */
let decreaser = document.getElementById('lower-quantity');
let quantity = document.getElementById('quantity');
let increaser = document.getElementById('increase-quantity');

/* DECREASE ON CLICK */
decreaser.onclick = function(){
...
/* SET CART VALUE AND ANIMATE NUMBER ON CART ICON */
...
let ingredientsHeading = document.querySelectorAll('.ingredientsHeading');
for(var i = 0; i < ingredientsHeading.length; i++){
    ingredientsHeading[i].onclick = function(){
